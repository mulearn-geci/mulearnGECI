                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-6">
                      <h3
                        onClick={() => openLightbox(event, 0)}
                        className="text-xl font-semibold text-gray-900 dark:text-white mb-3 leading-tight cursor-pointer hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                      >
                        {event.title}
                      </h3>
